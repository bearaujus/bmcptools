...
func Register(s toolreg.ToolRegistrar) {
	s.AddTool(mcp.NewTool(toolname.ListDirectory,
		...
		mcp.WithString("detail", mcp.Description(asset.ParamDesc(toolname.ListDirectory, "detail"))),
	...
	s.AddTool(mcp.NewTool(toolname.DirectoryTree,
		...
		mcp.WithString("detail", mcp.Description(asset.ParamDesc(toolname.DirectoryTree, "detail"))),
		mcp.WithString("glob",
