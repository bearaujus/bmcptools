...
func Register(s toolreg.ToolRegistrar) {
	s.AddTool(mcp.NewTool(toolname.SearchFiles,
		...
		mcp.WithNumber("offset", mcp.Description(asset.ParamDesc(toolname.SearchFiles, "offset"))),
	...
	s.AddTool(mcp.NewTool(toolname.GrepFiles,
		...
		mcp.WithNumber("max_matches_per_file", mcp.Description(asset.ParamDesc(toolname.GrepFiles, "max_matches_per_file"))),
